            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <a class="btn_2 d-none d-lg-block" href="#">Welcome,<% out.print(session.getAttribute("uname"));%></a>
                    </nav>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-5 col-xl-5">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <a href="#regervation_part_iner" class="btn_2">Make an appointment</a>
                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
						...
						%>
                                ...
                                <tr>
                                    ...
                                    <td><a href="deleteapp?aid=<%=resultSet.getString("aid") %>"><input type="button" class="btn btn-primary" value="Delete">
                                    </td>
                        ...
                        <form method="post" action="addappointment">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <input type="name" class="form-control" id="aname" name="aname" placeholder="Patient Name">
                                </div>
                                
                                <div class="form-group col-md-6">
                                    <input type="email" class="form-control" id="aemail" name="aemail" placeholder="Email address">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    <textarea class="form-control" id="Textarea" name="anote" rows="4" placeholder="Your Note "></textarea>
                                       
                                </div>
                                <input type="hidden" name="usname" value="<% out.print(session.getAttribute("uname")); %>">
                            </div>
                            <input class="btn_2 d-none d-lg-block" type="submit" value="Make an Appointment">
